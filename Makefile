...
ifneq ($(strip $(PORTAL_RELEASE_REPOSITORY_URL)),)
	BUILD_ARGS += --dart-define PORTAL_RELEASE_REPOSITORY_URL=$(PORTAL_RELEASE_REPOSITORY_URL)
	DISTRIBUTOR_ARGS += --build-dart-define PORTAL_RELEASE_REPOSITORY_URL=$(PORTAL_RELEASE_REPOSITORY_URL)
endif

ifneq ($(strip $(PORTAL_RELEASES_API_URL)),)
	BUILD_ARGS += --dart-define PORTAL_RELEASES_API_URL=$(PORTAL_RELEASES_API_URL)
	DISTRIBUTOR_ARGS += --build-dart-define PORTAL_RELEASES_API_URL=$(PORTAL_RELEASES_API_URL)
endif

ifneq ($(strip $(PORTAL_RELEASES_LATEST_URL)),)
	BUILD_ARGS += --dart-define PORTAL_RELEASES_LATEST_URL=$(PORTAL_RELEASES_LATEST_URL)
	DISTRIBUTOR_ARGS += --build-dart-define PORTAL_RELEASES_LATEST_URL=$(PORTAL_RELEASES_LATEST_URL)
endif

ifneq ($(strip $(PORTAL_RELEASES_APPCAST_URL)),)
	BUILD_ARGS += --dart-define PORTAL_RELEASES_APPCAST_URL=$(PORTAL_RELEASES_APPCAST_URL)
	DISTRIBUTOR_ARGS += --build-dart-define PORTAL_RELEASES_APPCAST_URL=$(PORTAL_RELEASES_APPCAST_URL)
endif

ifneq ($(strip $(PORTAL_WARP_DEFAULTS_URL)),)
	BUILD_ARGS += --dart-define PORTAL_WARP_DEFAULTS_URL=$(PORTAL_WARP_DEFAULTS_URL)
	DISTRIBUTOR_ARGS += --build-dart-define PORTAL_WARP_DEFAULTS_URL=$(PORTAL_WARP_DEFAULTS_URL)
endif
